...
# List of vulnerable package@versions (updated from S1ngularity/Nx attack article)
VULNS=(
  ...
  "@things-factory/email-base@9.048"
  ...
  "@things-factory/email-base@9.053"
  "@things-factory/email-base@9.054"
